...
def index():
    if request.method == 'POST':
        ...
        print(f'app.py 41 line: char_user = {char_user}, GPM = {GPM}, VSPM = {VSPM}, DPM = {DPM}, KP = {KP}, XPD = {XPD}, tier = {tier}, rank = {rank}, iconnum = {iconnum}')
        #입력 데이터 전처리 
        ...
        #print(f'app.py:46 GPM_user = {GPM_user}, VSPM_user = {VSPM_user}, DPM_user = {DPM_user}, KP_user = {KP_user}, XPD_user = {XPD_user}')
        #프로 선수 데이터 DB에서 가져오기
